...
public class Asignaturas extends javax.swing.JPanel {
    ...
    public Asignaturas() {
        initComponents();
        ControladorAsignatura controladorAsignatura = new ControladorAsignatura(this);
    }

    public Asignaturas(int fila) {
        initComponents();
        ControladorAsignatura controladorAsignatura = new ControladorAsignatura(this);
    ...
    public Asignaturas(String asignatura) {
        ...
        for (int i = 0; i < myTable1.getRowCount(); i++) {
            String nombre = (String) myTable1.getValueAt(i, 1);
            if (nombre.equals(asignatura)) {
                myTable1.setRowSelectionInterval(i, i);
                Rectangle rect = myTable1.getCellRect(i, 0, true);
                myTable1.scrollRectToVisible(rect);
                break;                
            }
        }
    ...
    private void initComponents() {
        ...
        myTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Asignatura", "Valor del area", "Area"
            }
        ) {
        ...
        if (myTable1.getColumnModel().getColumnCount() > 0) {
            ...
            myTable1.getColumnModel().getColumn(1).setPreferredWidth(140);
            myTable1.getColumnModel().getColumn(2).setResizable(false);
            myTable1.getColumnModel().getColumn(3).setResizable(false);
            myTable1.getColumnModel().getColumn(3).setPreferredWidth(200);
        }
        ...
        txtBuscar.setText("Ingrese el nombre de la asignatura a buscar");
        txtBuscar.setPlaceHolder("Ingrese el nombre de la asignatura a buscar");
